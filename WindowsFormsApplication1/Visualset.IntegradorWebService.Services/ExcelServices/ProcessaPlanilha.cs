            ...
            switch (tipoArquivo.ToUpper())
            {
                ...
                case "TXT":
                    ...
                    while ((line = file.ReadLine()) != null)
                    {
                        ...
                        string linhaSelecionada = (from s in line where line.Substring(0, 1).Equals("2") select line).FirstOrDefault();
                    ...
                    foreach (var l in lista)
                    {
                        ...
                        {
                            oFormatacao.Valor = (from s in l select l.Substring(oFormatacao.Inicio - 1, oFormatacao.Tamanho)).FirstOrDefault().Trim();
                        }
